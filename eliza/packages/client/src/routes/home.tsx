...
import { ThoughtStream } from '@/components/mezo/ThoughtStream';
import { YieldChart } from '@/components/mezo/YieldChart';
import { SessionKeyManager } from '@/components/mezo/SessionKeyManager';
  ...
  return (
    <>
      <div className="flex w-full h-full overflow-hidden">
        <div className="flex-1 w-full overflow-y-auto bg-background transition-colors duration-500">
        ...
        {/* Mezo Terminal Side Panel */}
        <div className="w-[400px] border-l border-border bg-black/95 hidden xl:flex flex-col p-4 gap-6 shadow-2xl z-10">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-3 h-3 rounded-full bg-green-500 animate-pulse"></div>
            <h2 className="text-green-500 font-mono font-bold text-lg tracking-widest">MEZO TERMINAL</h2>
          </div>
